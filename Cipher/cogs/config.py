...
@app_commands.command(name="dashboard", description="Get the link to this servers dashboard")
async def dashboard(interaction: discord.Interaction):
	interaction.response.send_message(f"The link to this servers dashboard is https://PLACEHOLDER/{interaction.guild.id}/", ephemeral=True)
